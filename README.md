...
# To-do list
- [x] Resolve 'hand-object detector' model download  issue: it currently often fails to download the model from Google Drive automatically. I may need to put it somewhere else and then put other script download file automatically. At the moment, you can download directly from the origianl 100DOH repository. <= This was resolved in another brach of this repository using Git-LFS. Please check [ICL/MPF](https://github.com/ImperialCollegeLondon/MessagePassingFramework)
